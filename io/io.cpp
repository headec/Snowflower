...
Cio::Cio()
	...
	, ioService_(reinterpret_cast<protocol::rpc::frame_t*>(&m_Outputs.ToTwinCAT), reinterpret_cast<protocol::rpc::frame_t*>(&m_Inputs.FromTwinCAT))
{
...
HRESULT Cio::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
	...
	ioService_.write(protocol::rpc::frame_t(protocol::rpc::id::btn::status, { btn_.read(), btn_.isEdge() }));

	switch (ioService_.read().Id)
	{
	case protocol::rpc::id::led::set:
